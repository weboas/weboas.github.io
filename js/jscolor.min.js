...
window.jscolor || (window.jscolor = function() {
    var e, n, t, r, o, i, v = {
        ...
        tryInstallOnElements: function(e, t) {
            for (var n = new RegExp("(^|\\s)(" + t + ")(\\s*(\\{[^}]*\\})|\\s|$)", "i"), o = 0; o < e.length; o += 1) {
                var r;
                if (void 0 === e[o].type || "color" != e[o].type.toLowerCase() || !v.isColorAttrSupported)
                    if (!e[o].jscolor && e[o].className && (r = e[o].className.match(n))) {
                        var i = e[o],
                            s = null,
                            l = v.getDataAttr(i, "jscolor");
        ...
        isColorAttrSupported: (i = document.createElement("input"), !(!i.setAttribute || (i.setAttribute("type", "color"), "color" != i.type.toLowerCase()))),
        isCanvasSupported: (o = document.createElement("canvas"), !(!o.getContext || !o.getContext("2d"))),
        ...
        attachGroupEvent: function(e, t, n, o) {
            v._attachedGroupEvents.hasOwnProperty(e) || (v._attachedGroupEvents[e] = []), v._attachedGroupEvents[e].push([t, n, o]), v.attachEvent(t, n, o)
        },
        detachGroupEvents: function(e) {
            if (v._attachedGroupEvents.hasOwnProperty(e)) {
                for (var t = 0; t < v._attachedGroupEvents[e].length; t += 1) {
                    var n = v._attachedGroupEvents[e][t];
        ...
        fireEvent: function(e, t) {
            if (e)
                if (document.createEvent)(n = document.createEvent("HTMLEvents")).initEvent(t, !0, !0), e.dispatchEvent(n);
        ...
        setClass: function(e, t) {
            for (var n = v.classNameToList(t), o = 0; o < n.length; o += 1) v.hasClass(e, n[o]) || (e.className += (e.className ? " " : "") + n[o])
        },
        unsetClass: function(e, t) {
            for (var n = v.classNameToList(t), o = 0; o < n.length; o += 1) {
        ...
        setStyle: (n = document.createElement("div"), t = function(e) {
        ...
        getRelPointerPos: function(e) {
            ...
            var t = (e.target || e.srcElement).getBoundingClientRect(),
                n = 0,
                o = 0;
            return void 0 !== e.changedTouches && e.changedTouches.length ? (n = e.changedTouches[0].clientX, o = e.changedTouches[0].clientY) : "number" == typeof e.clientX && (n = e.clientX, o = e.clientY), {
                x: n - t.left,
                y: o - t.top
            }
        },
        ...
        redrawPosition: function() {
            if (v.picker && v.picker.owner) {
                var e, t, n = v.picker.owner;
                n.fixed ? (e = v.getElementPos(n.targetElement, !0), t = [0, 0]) : (e = v.getElementPos(n.targetElement), t = v.getViewPos());
                var o, r, i, s = v.getElementSize(n.targetElement),
                    l = v.getViewSize(),
                    a = v.getPickerOuterDims(n);
                ...
                var d = (s[r] + a[r]) / 2;
                if (n.smartPosition) c = [-t[o] + e[o] + a[o] > l[o] && -t[o] + e[o] + s[o] / 2 > l[o] / 2 && 0 <= e[o] + s[o] - a[o] ? e[o] + s[o] - a[o] : e[o], -t[r] + e[r] + s[r] + a[r] - d + d * i > l[r] ? -t[r] + e[r] + s[r] / 2 > l[r] / 2 && 0 <= e[r] + s[r] - d - d * i ? e[r] + s[r] - d - d * i : e[r] + s[r] - d + d * i : 0 <= e[r] + s[r] - d + d * i ? e[r] + s[r] - d + d * i : e[r] + s[r] - d - d * i];
                else var c = [e[o], e[r] + s[r] - d + d * i];
                var h = c[o],
                    p = c[r],
                    u = n.fixed ? "fixed" : "absolute",
                    m = (c[0] + a[0] > e[0] || c[0] < e[0] + s[0]) && c[1] + a[1] < e[1] + s[1];
                v._drawPosition(n, h, p, u, m)
            }
        },
        _drawPosition: function(e, t, n, o, r) {
            var i = r ? 0 : e.shadowBlur;
            v.picker.wrap.style.position = o, v.picker.wrap.style.left = t + "px", v.picker.wrap.style.top = n + "px", v.setBoxShadow(v.picker.boxS, e.shadow ? new v.BoxShadow(0, i, e.shadowBlur, 0, e.shadowColor) : null)
        },
        getPickerDims: function(e) {
            var t = !!v.getSliderComponent(e);
            return [2 * e.insetWidth + 2 * e.padding + e.width + (t ? 2 * e.insetWidth + v.getPadToSliderPadding(e) + e.sliderSize : 0), 2 * e.insetWidth + 2 * e.padding + e.height + (e.closable ? 2 * e.insetWidth + e.padding + e.buttonHeight : 0)]
        },
        ...
        getSliderComponent: function(e) {
            if (2 < e.mode.length) switch (e.mode.charAt(2).toLowerCase()) {
                case "s":
                    return "s";
                case "v":
                    return "v"
        ...
        onDocumentMouseDown: function(e) {
            ...
            t._jscLinkedInstance ? t._jscLinkedInstance.showOnClick && t._jscLinkedInstance.show() : t._jscControlName && v.onControlPointerStart(e, t, t._jscControlName, "mouse")
        },
        onDocumentTouchStart: function(e) {
            e || (e = window.event);
            var t = e.target || e.srcElement;
            t._jscLinkedInstance ? t._jscLinkedInstance.showOnClick && t._jscLinkedInstance.show() : t._jscControlName && v.onControlPointerStart(e, t, t._jscControlName, "touch")
        },
        ...
        onControlPointerStart: function(n, o, r, i) {
            var e = o._jscInstance;
            v.preventDefault(n), v.captureTarget(o);
            var t = function(e, t) {
                v.attachGroupEvent("drag", e, v._pointerMoveEvent[i], v.onDocumentPointerMove(n, o, r, i, t)), v.attachGroupEvent("drag", e, v._pointerEndEvent[i], v.onDocumentPointerEnd(n, o, r, i))
            };
            ...
            var a = v.getAbsPointerPos(n),
                d = v.getRelPointerPos(n);
        ...
        onDocumentPointerMove: function(e, n, o, t, r) {
            return function(e) {
                ...
                switch (o) {
                    case "pad":
                        e || (e = window.event), v.setPad(t, e, r[0], r[1]), v.dispatchFineChange(t);
                        break;
                    case "sld":
                        e || (e = window.event), v.setSld(t, e, r[1]), v.dispatchFineChange(t)
                }
            }
        },
        ...
        setPad: function(e, t, n, o) {
            var r = v.getAbsPointerPos(t),
                i = n + r.x - v._pointerOrigin.x - e.padding - e.insetWidth,
                s = o + r.y - v._pointerOrigin.y - e.padding - e.insetWidth,
                l = i * (360 / (e.width - 1)),
                a = 100 - s * (100 / (e.height - 1));
        ...
        setSld: function(e, t, n) {
            var o = 100 - (n + v.getAbsPointerPos(t).y - v._pointerOrigin.y - e.padding - e.insetWidth) * (100 / (e.height - 1));
            switch (v.getSliderComponent(e)) {
                case "s":
        ...
        initVML: function() {
            if (!v._vmlReady) {
                ...
                if (e.namespaces[v._vmlNS] || e.namespaces.add(v._vmlNS, "urn:schemas-microsoft-com:vml"), !e.styleSheets[v._vmlCSS]) {
                    ...
                    for (var o = 0; o < t.length; o += 1) n.addRule(v._vmlNS + "\\:" + t[o], "behavior:url(#default#VML);")
                }
                v._vmlReady = !0
            }
        },
            ...
            if (v.isCanvasSupported) {
                var i = document.createElement("canvas"),
                    ...
                    t = function(e, t, n) {
                        ...
                        var o = s.createLinearGradient(0, 0, i.width, 0);
                        o.addColorStop(0, "#F00"), o.addColorStop(1 / 6, "#FF0"), o.addColorStop(2 / 6, "#0F0"), o.addColorStop(.5, "#0FF"), o.addColorStop(4 / 6, "#00F"), o.addColorStop(5 / 6, "#F0F"), o.addColorStop(1, "#F00"), s.fillStyle = o, s.fillRect(0, 0, i.width, i.height);
                        var r = s.createLinearGradient(0, 0, 0, i.height);
                ...
                var r = document.createElement(v._vmlNS + ":fill");
                r.type = "gradient", r.method = "linear", r.angle = "90", r.colors = "16.67% #F0F, 33.33% #00F, 50% #0FF, 66.67% #0F0, 83.33% #FF0";
                var l = document.createElement(v._vmlNS + ":rect");
                l.style.position = "absolute", l.style.left = "-1px", l.style.top = "-1px", l.stroked = !1, l.appendChild(r), o.appendChild(l);
                var a = document.createElement(v._vmlNS + ":fill");
                a.type = "gradient", a.method = "linear", a.angle = "180", a.opacity = "0";
                var d = document.createElement(v._vmlNS + ":rect");
                d.style.position = "absolute", d.style.left = "-1px", d.style.top = "-1px", d.stroked = !1, d.appendChild(a), o.appendChild(d);
                t = function(e, t, n) {
                    switch (o.style.width = e + "px", o.style.height = t + "px", l.style.width = d.style.width = e + 1 + "px", l.style.height = d.style.height = t + 1 + "px", r.color = "#F00", r.color2 = "#F00", n.toLowerCase()) {
                        case "s":
            ...
            if (v.isCanvasSupported) {
                var i = document.createElement("canvas"),
                    ...
                    t = function(e, t, n, o) {
                        i.width = e, i.height = t, s.clearRect(0, 0, i.width, i.height);
                        var r = s.createLinearGradient(0, 0, 0, i.height);
                        r.addColorStop(0, n), r.addColorStop(1, o), s.fillStyle = r, s.fillRect(0, 0, i.width, i.height)
                    };
                e.elm = i, e.draw = t
            } else {
                v.initVML();
                ...
                var l = document.createElement(v._vmlNS + ":fill");
                l.type = "gradient", l.method = "linear", l.angle = "180";
                var a = document.createElement(v._vmlNS + ":rect");
                a.style.position = "absolute", a.style.left = "-1px", a.style.top = "-1px", a.stroked = !1, a.appendChild(l), r.appendChild(a);
                t = function(e, t, n, o) {
                    r.style.width = e + "px", r.style.height = t + "px", a.style.width = e + 1 + "px", a.style.height = t + 1 + "px", l.color = n, l.color2 = o
                };
                e.elm = r, e.draw = t
            }
            return e
        ...
        leavePad: 4,
        leaveSld: 8,
        BoxShadow: (e = function(e, t, n, o, r, i) {
            this.hShadow = e, this.vShadow = t, this.blur = n, this.spread = o, this.color = r, this.inset = !!i
        ...
        jscolor: function(e, t) {
            ...
            function o() {
                h._processParentElementsInDOM(), v.picker || (v.picker = {
                    owner: null,
                ...
                var e, t, n = v.picker,
                    o = !!v.getSliderComponent(h),
                    r = v.getPickerDims(h),
                    i = 2 * h.pointerBorderWidth + h.pointerThickness + 2 * h.crossSize,
                    s = v.getPadToSliderPadding(h),
                    l = Math.min(h.borderRadius, Math.round(h.padding * Math.PI));
                ...
                n.btn.onmousedown = function() {
                    h.hide()
                }, n.btnT.style.lineHeight = h.buttonHeight + "px", n.btnT.innerHTML = "", n.btnT.appendChild(document.createTextNode(h.closeText)), a(), d(), v.picker.owner && v.picker.owner !== h && v.unsetClass(v.picker.owner.targetElement, h.activeClass), v.picker.owner = h, v.isElementType(p, "body") ? v.redrawPosition() : v._drawPosition(h, 0, 0, "relative", !1), n.wrap.parentNode != p && p.appendChild(n.wrap), v.setClass(h.targetElement, h.activeClass)
            }
            ...
            function a() {
                ...
                var t = Math.round(h.hsv[0] / 360 * (h.width - 1)),
                    ...
                    r = -Math.floor(o / 2);
                switch (v.picker.cross.style.left = t + r + "px", v.picker.cross.style.top = n + r + "px", v.getSliderComponent(h)) {
                    case "s":
                        var i = c(h.hsv[0], 100, h.hsv[2]),
                            s = c(h.hsv[0], 0, h.hsv[2]),
                            l = "rgb(" + Math.round(i[0]) + "," + Math.round(i[1]) + "," + Math.round(i[2]) + ")",
                            a = "rgb(" + Math.round(s[0]) + "," + Math.round(s[1]) + "," + Math.round(s[2]) + ")";
                        v.picker.sldGrad.draw(h.sliderSize, h.height, l, a);
                        break;
                    case "v":
                        var d = c(h.hsv[0], h.hsv[1], 100);
                        l = "rgb(" + Math.round(d[0]) + "," + Math.round(d[1]) + "," + Math.round(d[2]) + ")", a = "#000";
                        v.picker.sldGrad.draw(h.sliderSize, h.height, l, a)
                }
            }

            function d() {
                var e = v.getSliderComponent(h);
                if (e) {
                    switch (e) {
                        case "s":
                            var t = 1;
                    ...
                    v.picker.sldPtrOB.style.top = n - (2 * h.pointerBorderWidth + h.pointerThickness) - Math.floor(u / 2) + "px"
                }
            }
            ...
            if (this.hide = function() {
                    r() && (v.unsetClass(h.targetElement, h.activeClass), v.picker.wrap.parentNode.removeChild(v.picker.wrap), delete v.picker.owner)
                }, this.show = function() {
                    o()
                    ...
                    if (!(e & v.leaveValue) && this.valueElement) {
                        var t = this.toString();
                        this.uppercase && (t = t.toUpperCase()), this.hash && (t = "#" + t), v.isElementType(this.valueElement, "input") ? this.valueElement.value = t : this.valueElement.innerHTML = t
                    }
                    if (!(e & v.leaveStyle) && this.styleElement) {
                        var n = "#" + this.toString(),
                            o = this.isLight() ? "#000" : "#FFF";
                        this.styleElement.style.backgroundImage = "none", this.styleElement.style.backgroundColor = n, this.styleElement.style.color = o, this.overwriteImportant && this.styleElement.setAttribute("style", "background: " + n + " !important; color: " + o + " !important;")
                    }
                    e & v.leavePad || !r() || a(), e & v.leaveSld || !r() || d()
                    ...
                    this.rgb = c(null === e ? this.hsv[0] : this.hsv[0] = e, null === t ? this.hsv[1] : this.hsv[1] = t, null === n ? this.hsv[2] : this.hsv[2] = n), this.exportColor(o)
                    ...
                    var r = function(e, t, n) {
                        e /= 255, t /= 255, n /= 255;
                        var o = Math.min(Math.min(e, t), n),
                            r = Math.max(Math.max(e, t), n),
                            i = r - o;
                        if (0 === i) return [null, 0, 100 * r];
                        var s = e === o ? 3 + (n - t) / i : t === o ? 5 + (e - n) / i : 1 + (t - e) / i;
                        return [60 * (6 === s ? 0 : s), i / r * 100, 100 * r]
                    }(null === e ? this.rgb[0] : e, null === t ? this.rgb[1] : t, null === n ? this.rgb[2] : n);
                    null !== r[0] && (this.hsv[0] = Math.max(0, Math.min(360, r[0]))), 0 !== r[2] && (this.hsv[1] = null === r[1] ? null : Math.max(0, this.minS, Math.min(100, this.maxS, r[1]))), this.hsv[2] = null === r[2] ? null : Math.max(0, this.minV, Math.min(100, this.maxV, r[2]));
                    var i = c(this.hsv[0], this.hsv[1], this.hsv[2]);
                    this.rgb[0] = i[0], this.rgb[1] = i[1], this.rgb[2] = i[2], this.exportColor(o)
                    ...
                    if (n = e.match(/^\W*rgba?\(([^)]*)\)\W*$/i)) {
                        var o, r, i, s = n[1].split(","),
                            l = /^\s*(\d*)(\.\d+)?\s*$/;
                        if (3 <= s.length && (o = s[0].match(l)) && (r = s[1].match(l)) && (i = s[2].match(l))) {
                            var a = parseFloat((o[1] || "0") + (o[2] || "")),
                                d = parseFloat((r[1] || "0") + (r[2] || "")),
                    ...
                    if (!this._linkedElementsProcessed) {
                        ...
                        do {
                            var t = v.getStyle(e);
                            t && "fixed" === t.position.toLowerCase() && (this.fixed = !0), e !== this.targetElement && (e._jscEventsAttached || (e._jscEventsAttached = !0))
                        } while ((e = e.parentNode) && !v.isElementType(e, "body"))
                    }
                }, "string" == typeof e) {
                var i = e,
                    s = document.getElementById(i);
                s ? this.targetElement = s : v.warn("Could not find target element with ID '" + i + "'")
            } else e ? this.targetElement = e : v.warn("Invalid target element: '" + e + "'");
            if (this.targetElement._jscLinkedInstance) v.warn("Cannot link jscolor twice to the same element. Skipping.");
            else {
                (this.targetElement._jscLinkedInstance = this).valueElement = v.fetchElement(this.valueElement), this.styleElement = v.fetchElement(this.styleElement);
                var h = this,
                    p = this.container ? v.fetchElement(this.container) : document.getElementById("pickerContainer"),
                    u = 3;
                ...
                if (this.valueElement && v.isElementType(this.valueElement, "input")) {
                    var m = function() {
                        h.fromString(h.valueElement.value, v.leaveValue), v.dispatchFineChange(h)
                    };
                    v.attachEvent(this.valueElement, "keyup", m), v.attachEvent(this.valueElement, "input", m), v.attachEvent(this.valueElement, "blur", function() {
                        h.importColor()
